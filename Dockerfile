...
RUN wget https://download2.rstudio.org/rstudio-server-rhel-$RSTUDIO_VER-x86_64.rpm \
	&& echo "f8dca075fab9e002c7efcd089396725e  rstudio-server-rhel-$RSTUDIO_VER-x86_64.rpm" > RSTUDIOMD5 \
...
# Libreoffice
ENV LIBREOFFICE_VER 5.2.1
ENV LIBREOFFICE_VER_MINOR .2

RUN wget http://download.documentfoundation.org/libreoffice/stable/5.2.1/$LIBREOFFICE_VER/x86_64/LibreOffice_${LIBREOFFICE_VER}_Linux_x86-64_rpm.tar.gz \
...
# Shiny
ENV SHINY_VER 1.4.4.807

RUN R -e 'install.packages("shiny")' \
	&& wget https://download3.rstudio.org/centos5.9/x86_64/shiny-server-$SHINY_VER-rh5-x86_64.rpm \
	&& echo "5c0d5ddaf97548d79393a5b9c800ec64  shiny-server-$SHINY_VER-rh5-x86_64.rpm" > SHINYSERVERMD5 \
